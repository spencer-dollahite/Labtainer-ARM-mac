...
| Where to get it | Distributed by your instructor. A public download is planned but **not yet hosted**. | Hosted by NPS today: [nps.edu/web/c3o/virtual-machine-images](https://nps.edu/web/c3o/virtual-machine-images) |

**Rule of thumb:** if your instructor has given you the arm64 appliance, use Option A. Otherwise use Option B; it is the same image NPS supports for everyone, it just runs slower on Apple Silicon.
...
> **Status:** the appliance is not yet publicly hosted. Use the download link your instructor gives you. If you have not been given one, use [Option B](#option-b-official-x86_64-qcow2-image-slower-all-labs).
...
1. **Verify the download** if your instructor gave you a SHA-256 checksum. In Terminal: `shasum -a 256 ~/Downloads/<file>.utm.zip` and compare.
